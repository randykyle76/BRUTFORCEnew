...
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" RANDY KYLE  [FR13ND9]"$i"          |"
echo $i" |"$pu" FACEBOOK :"$ku" RANDY RILEY"$i"                   |"
echo $i" |"$pu" THANKS TO :"$cy"~ [MR.KYLE] [MR.S∆MAx] [MR.R]"$i"  |"
echo $i" |"$cy"            ~ [cyber] [%MR.S%] [AldykaPrygh]"$i" |"
echo $i" |"$pu" Contack WhatsApp :"$ku" +6285772181664"$i"             |"
echo $i" |"$pu" Contack Gmail :"$ku" randigagah89@gmail.com"$i"      |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
echo $i"|"$me" 1"$i" |"$cy" BRUTEFORCE FB PHP        "$i"|"$i"    |"$cy" B"$i" |"
echo $i"|"$me" 2"$i" |"$cy" BRUTEFORCE FB R4NDY    "$i"|"$i"    |"$cy" E"$i" |"
echo $i"|"$me" 3"$i" |"$cy" BRUTEFORCE FB WILIAM     "$i"|"$i"    |"$cy" N"$i" |"
...
sleep 1
git clone https://github.com/randykyle76/BRUTEFORCEnew
cd fbbrute
php fb.php
fi
...
sleep 2
echo $ku"WhatsApp :"$i" +6285772181664"
echo $ku"Facebook :"$i" RANDY KYLE"
sleep 2
